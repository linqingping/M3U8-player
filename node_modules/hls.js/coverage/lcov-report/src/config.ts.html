...
&nbsp;
  // Dynamic Modules
  ...timelineConfig(),
  subtitleStreamController: (__USE_SUBTITLES__) ? SubtitleStreamController : <span class="branch-1 cbranch-no" title="branch not covered" >void 0,</span>
  subtitleTrackController: (__USE_SUBTITLES__) ? SubtitleTrackController : <span class="branch-1 cbranch-no" title="branch not covered" >void 0,</span>
  timelineController: (__USE_SUBTITLES__) ? TimelineController : <span class="branch-1 cbranch-no" title="branch not covered" >void 0,</span>
  audioStreamController: (__USE_ALT_AUDIO__) ? AudioStreamController : <span class="branch-1 cbranch-no" title="branch not covered" >void 0,</span>
  audioTrackController: (__USE_ALT_AUDIO__) ? AudioTrackController : <span class="branch-1 cbranch-no" title="branch not covered" >void 0,</span>
  emeController: (__USE_EME_DRM__) ? EMEController : <span class="branch-1 cbranch-no" title="branch not covered" >void 0</span>
};
&nbsp;
function timelineConfig (): TimelineControllerConfig {
  <span class="missing-if-branch" title="if path not taken" >I</span>if (!__USE_SUBTITLES__) {
...
<span class="cstat-no" title="statement not covered" >    return {</span>} as any;
  }
  return {
